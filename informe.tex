...
\begin{center}\includegraphics[width=0.9\linewidth,]{informe_files/figure-latex/anexo-frecuencia-compras-1} \end{center}

Durante la fase de limpieza de los 40,000 datos, me llamó la atención un
...
valores nulos y una alta consistencia en las categorías analizadas. Me
llamó la atención la variabilidad observada en la variable

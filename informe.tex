...
\toprule
Variable & Media & Mediana & Desv. Est. & Mín. & Máx. & N & Varianza\\
\midrule
\textbf{\cellcolor{gray!10}{Age}} & \cellcolor{gray!10}{31.99} & \cellcolor{gray!10}{32} & \cellcolor{gray!10}{10.04} & \cellcolor{gray!10}{15} & \cellcolor{gray!10}{49} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA}\\
\textbf{Horas} & NA & NA & NA & NA & NA & 12.02 & NA\\
\textbf{\cellcolor{gray!10}{Horas}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{12.01} & \cellcolor{gray!10}{NA}\\
\textbf{Horas} & NA & NA & NA & NA & NA & 6.91 & NA\\
\textbf{\cellcolor{gray!10}{Horas}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{0.00} & \cellcolor{gray!10}{NA}\\
\addlinespace
\textbf{Horas} & NA & NA & NA & NA & NA & 24.00 & NA\\
\textbf{\cellcolor{gray!10}{InGamePurchases}} & \cellcolor{gray!10}{0.20} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{0.40} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA}\\
\textbf{Sesiones} & NA & NA & NA & NA & NA & NA & 9.47\\
\textbf{\cellcolor{gray!10}{Sesiones}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{9.00}\\
\textbf{Sesiones} & NA & NA & NA & NA & NA & NA & 5.76\\
\addlinespace
\textbf{\cellcolor{gray!10}{Sesiones}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{0.00}\\
\textbf{Sesiones} & NA & NA & NA & NA & NA & NA & 19.00\\
\textbf{\cellcolor{gray!10}{AvgSessionDurationMinutes}} & \cellcolor{gray!10}{94.79} & \cellcolor{gray!10}{95} & \cellcolor{gray!10}{49.01} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{179} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA}\\
\textbf{PlayerLevel} & 49.66 & 49 & 28.59 & 1 & 99 & NA & NA\\
\textbf{\cellcolor{gray!10}{AchievementsUnlocked}} & \cellcolor{gray!10}{24.53} & \cellcolor{gray!10}{25} & \cellcolor{gray!10}{14.43} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{49} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA}\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}\includegraphics[width=0.9\linewidth,]{informe_files/figure-latex/grafica_frecuencias_libres-1} \end{center}
...
{\centering \includegraphics[width=0.8\linewidth,height=0.3\textheight,]{informe_files/figure-latex/grafico-popularidad-1} 
...
{\centering \includegraphics[width=0.85\linewidth,]{informe_files/figure-latex/boxplot-compromiso-final-1} 
...
{\centering \includegraphics[width=1\linewidth,]{informe_files/figure-latex/comparativa-interaccion-azul-fuerte-1} 

}

\caption{Distribución de Horas vs. Sesiones por Género}\label{fig:comparativa-interaccion-azul-fuerte}
\end{figure}

El análisis visual de dispersión segmentado por género revela una
distribución uniforme y rectangular en todos los paneles. Esta forma del
gráfico indica que no existe una correlación lineal fuerte entre la
cantidad de sesiones y las horas totales; es decir, en cada género
encontramos de manera equitativa a todo tipo de jugadores: desde
aquellos con pocas sesiones y pocas horas, hasta los que presentan una
alta frecuencia y dedicación.
...
{\centering \includegraphics[width=0.85\linewidth,]{informe_files/figure-latex/verificacion-correlacion-1} 

}

\caption{Correlación Lineal entre Sesiones y Horas}\label{fig:verificacion-correlacion}
\end{figure}

Para verificar si un aumento en las sesiones semanales se traduce
necesariamente en una mayor cantidad de horas totales, se calculó el
Coeficiente de Correlación de Pearson, obteniendo un valor de -0.0037.
Desde el punto de vista estadístico, este resultado indica una
correlación nula, lo que significa que la constancia semanal y la
dedicación horaria operan como variables independientes.
...
garantiza un mayor tiempo total, las empresas deben diseñar incentivos
diferenciados que premien por igual los accesos rápidos diarios
(micro-objetivos) y las sesiones de larga duración (macro-objetivos).
Este enfoque permite captar el valor de ambos perfiles de usuario de
forma aislada, optimizando la retención al adaptar la oferta de
contenido al estilo de vida específico de cada jugador en lugar de
aplicar un modelo de métricas unificado.

...
{\centering \includegraphics[width=1\linewidth,]{informe_files/figure-latex/comparativa-interaccion-1} 
...
\begin{center}\includegraphics[width=0.9\linewidth,]{informe_files/figure-latex/analisis-correlacion-definitivo-1} \end{center}
...
obtuvo un valor de Correlacion (aproximadamente 0). Al ser un valor
prácticamente nulo, actúa como evidencia descriptiva de que no existe
una relación lineal entre las variables analizadas.
